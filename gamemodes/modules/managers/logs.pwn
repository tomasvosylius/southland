...
#define log_commit() 						mysql_tquery(log_chandler, __log_string, "LogAdded")*/
...
#define log_init(%0)					new bool:__log_vs = false; __log_E = %0
...
#define log_commit() 					__log_E && __log_vs && strlen(__log_string) && mysql_tquery(log_chandler, __log_string, "LogAdded")
